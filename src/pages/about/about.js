...
const loader = document.querySelector('.certificate-of-completion-image-container .loader');
...
function calcCertificateNextIndexOnArrowBackClick(currentDisplayedCertificate) {
    ...
    return (
        (currentDisplayedCertificateIndex - 1 + CERTIFICATES_OF_COMPLETION.length) % CERTIFICATES_OF_COMPLETION.length
    );
}
